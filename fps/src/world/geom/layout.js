...
export const LAYOUT = {
  ...
  buildings: [
    ...
    { x: -37, z: -6,  w: 12, d: 16, storeys: 2, wall: 'brick',
    ...
    // Plaza north side
    { x: -2, z: -28, w: 18, d: 12, storeys: 3, wall: 'plaster',
    ...
    { x: 16, z: 14, w: 12, d: 12, storeys: 1, wall: 'concreteWall', floor: 'concrete',
      doors: [{ side: 'w', at: 0.5 }],
      windows: [{ side: 'w', at: 0.2, w: 1.6 }, { side: 'n', at: 0.5, w: 1.6 }] },

    // Harbour warehouse — big shed with the catwalk ring
    { x: 22, z: -18, w: 20, d: 18, storeys: 2, wall: 'corrugated', floor: 'concrete',
